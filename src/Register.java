...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(etext, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 280, 267, -1));

        ptext.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jPanel1.add(ptext, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 200, 267, -1));
...
try{
    ...
    try {
        ...
        Logger.getLogger(Register.class.getName()).log(Level.SEVERE, null, ex);
          ...
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/billings","root","");
    String sql="insert into billing2 values ('"+utext.getText()+"','"+ptext.getText()+"','"+etext.getText()+"','"+mtext.getText()+"')";
